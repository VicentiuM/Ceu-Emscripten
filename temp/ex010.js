...
/* memory initializer */ allocate([72,101,108,108,111,32,87,111,114,108,100,33,10,0,0,0,114,101,113,117,101,115,116,65,110,105,109,97,116,105,111,110,70,114,97,109,101,40,100,114,97,119,49,41,0,0,0,0,114,101,113,117,101,115,116,65,110,105,109,97,116,105,111,110,70,114,97,109,101,40,100,114,97,119,41,0,0,0,0,0,95,98,101,103,105,110,40,41,0,0,0,0,0,0,0,0], "i8", ALLOC_NONE, Runtime.GLOBAL_BASE);
...
function _ceu_sys_go_stk($app,$evt,$evtp,$stk){
 ...
 var $50=(($49+24)|0);
 var $51=HEAP32[(($50)>>2)];
 _ceu_sys_go_ex($47,$evt_,$48,$51,0,1);
 var $52=$2;
 var $53=($52|0)==248;
...
function _ceu_app_init($app){
 ...
 var $15=(($14+24)|0);
 var $16=HEAP32[(($15)>>2)];
 _ceu_sys_org_init($16,1,2,0,0,0,0);
 var $17=$1;
 var $18=(($17+24)|0);
 var $19=HEAP32[(($18)>>2)];
 var $20=(($19)|0);
...
function _ceu_app_go($_ceu_app,$_ceu_evt,$_ceu_org,$_ceu_trl,$_ceu_stk){
 ...
 var $10=$_ceu_lbl;
 var $11=(($10<<24)>>24);
 if(($11|0)==2){ label=2;break;}else if(($11|0)==1){ label=5;break;}else{label=8;break;}
 case 2: 
 label=3;break;
 case 3: 
 var $14=$1;
 ...
 var $30=$29;
 var $31=$30;
 var $32=_ceu_sys_wclock($14,250000,$31,0);
 label=4;break;
 case 4: 
 var $34=$4;
 var $35=$34;
 ...
 var $70=$69;
 var $71=$70;
 var $72=_ceu_sys_wclock($51,$54,0,$71);
 var $73=($72|0)!=0;
 if($73){label=7;break;}else{label=6;break;}
 case 6: 
 label=4;break;
 case 7: 
 var $76=_printf(8,(tempVarArgs=STACKTOP,STACKTOP = (STACKTOP + 1)|0,STACKTOP = (((STACKTOP)+7)&-8),(assert((STACKTOP|0) < (STACK_MAX|0))|0),HEAP32[((tempVarArgs)>>2)]=0,tempVarArgs)); STACKTOP=tempVarArgs;
 label=3;break;
 case 8: 
 STACKTOP=sp;return;
  default: assert(0, "bad label: " + label);
...
//@ sourceMappingURL=ex010.html.map